...
import { syncReturns } from "./_lib/mirror-sync.js";
  ...
  try {
    ...
    if (request.method === "GET") {
      ...
      return response.status(200).json({
        ...
        incomplete: true,
        seller_id: sellerId,
        note: "Sincronizacao oficial de devolucoes habilitada. O espelhamento Seller Center continua parcial ate a calibracao completa da regra de paridade.",
        records: listMirrorEntities("returns", { sellerId, limit }),
