...
- Name: mercado-livre.spec.ts >> /mercado-livre smoke >> regressão PERSISTENT_CLASSIFICATION_LOGIC_BUG — app enxerga pedidos do ML
- Location: e2e\smoke\mercado-livre.spec.ts:98:3
...
- generic [ref=e2]:
  ...
  - generic [ref=e6]:
    - generic [ref=e7]:
      ...
      - generic [ref=e9]:
        - text: EcoFerro
        - generic [ref=e10]: V 3.0
    - heading "Acesse seu painel" [level=1] [ref=e11]
    - paragraph [ref=e12]: Sistema integrado com Mercado Livre para gestao de etiquetas e operacoes logisticas.
    - generic [ref=e13]:
      - generic [ref=e14]:
        - generic [ref=e15]: Usuario
        - generic [ref=e16]:
          - img [ref=e17]
          - textbox [ref=e20]: admin.ecoferro
      - generic [ref=e21]:
        - generic [ref=e22]: Senha
        - generic [ref=e23]:
          - img [ref=e24]
          - textbox "Digite sua senha" [ref=e27]: Ecoferro@2026
          - button "Mostrar senha" [ref=e28] [cursor=pointer]:
            - img [ref=e29]
      - generic [ref=e32]:
        - button "Lembrar usuario" [ref=e33] [cursor=pointer]:
          - img [ref=e34]
        - generic [ref=e36]: Lembrar usuario
      - generic [ref=e37]: Usuario ou senha invalidos.
      - button "Entrar no painel" [ref=e38] [cursor=pointer]:
        - generic [ref=e39]: Entrar no painel
        - img [ref=e40]
```
